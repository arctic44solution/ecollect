          ...
          >
            {slides.map((slide, index) => (
              <div
                ...
                className={cn(
                  "absolute left-1/2 top-0 aspect-square overflow-hidden rounded-2xl bg-muted shadow-2xl will-change-transform border border-neutral-200/20",
                  cardClassName,
                )}
          ...
          {slides.map((_, index) => (
            <button
              ...
              className={cn(
                ...
                index === selected ? "bg-emerald-500 w-8" : "bg-neutral-300 dark:bg-neutral-700",
              )}
            />
          ))}
        </div>
